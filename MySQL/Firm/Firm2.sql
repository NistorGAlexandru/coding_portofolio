DROP DATABASE IF EXISTS curs7_firma;
CREATE DATABASE IF NOT EXISTS curs7_firma;
use curs7_firma;
...
-- Construiți un VIEW care să listeze angajații din departamentul cu ID= 4 si sa contina nume, prenume, salariu_annual Utilizati acest VIEW Adaugati inca 2 angajati, apoi utilizati VIEW-UL creat. 
